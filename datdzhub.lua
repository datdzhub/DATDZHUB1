...
local FlurioreLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/Ahmad0x02/0X02V072/main/Source.lua%20(2).txt?raw=true"))()
local Notify = FlurioreLib:MakeNotify({
	["Title"] = "DatDZ Hub |",
	["Description"] = "Dat Dz Store",
...
--
--\\ Create Main
    Fluent = loadstring(game:HttpGet("https://raw.githubusercontent.com/Ahmad0x02/0X02V072/main/main.lua"))()
    Window = Fluent:CreateWindow({
    Title = "DATDZ HUB |",
    SubTitle = "DATDZ Store",
    TabWidth = 120,
...
Tabs.hi:AddButton({
        Title = "Discord Server of DATDZ STORE",
        Description = "https://discord.gg/qWDGGNFK7d",
        Callback = function()            
       setclipboard("https://discord.gg/qWDGGNFK7d") 
       end
    })
Tabs.hi:AddButton({
        Title = "Discord Server of DATDZ STORE",
    ...
    ["embeds"] = {
        {
            ...
            ["fields"] = {
                ...
                {
                    ["name"] = "Thanks Used DATDZHUB!",
                    ["value"] = "**DATDZ HUB | DatDZ Store**",
                    ["inline"] = true          
                }
            }              
        }
