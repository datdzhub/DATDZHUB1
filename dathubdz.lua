...
notis.new("<Color=White>DATDZHUB MAIN<Color=/>"):Display()
notis.new("<Color=Blue>Founder: HaTienDat<Color=/>"):Display() 
notis.new("<Color=Red>Dm Discord: jjba_godx<Color=/>"):Display() 
...
local Window = RosieTeam:MakeWindow({Name = "DATDZHUB", HidePremium = false, SaveConfig = false, ConfigFolder = "Hirimi Hub Main"})
